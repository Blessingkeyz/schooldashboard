<template>
  <section class="px-4">
    <div class="w-full flex lg:block">
      ...
      <HeaderComp :show-search="false">Add Teachers</HeaderComp>
    </div>
    <!-- personal details -->
    <div class="bg-white rounded-2xl pb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2">
        ...
        <div class="grid px-5 pt-5 space-y-3 w-full">
          ...
          <input
            type="text"
            placeholder="Jackarta, Indonesia"
            class="pl-2 h-8 md:h-12 rounded-md border text-xs md:text-sm text-[#303972] bg-transparent py-2"
          />
        </div>
      </div>
    ...
    <div class="bg-white rounded-2xl my-5 md:my-8 pb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2">
        <div class="grid px-5 pt-5 space-y-3 w-full">
          ...
          <input
            type="text"
            placeholder="university Akedemi historia"
            class="pl-2 h-8 md:h-12 rounded-md border text-xs md:text-sm text-[#303972] bg-transparent py-2"
          />
        </div>
        <div class="grid px-5 pt-5 space-y-3 w-full">
        ...
        <div class="grid px-5 pt-5 space-y-3 w-full">
          <p class="text-xs text-[#303972] md:text-lg font-semibold">City *</p>
          <input
            type="text"
            placeholder="Yogyokarta, Indonesia"
            class="pl-2 h-8 md:h-12 rounded-md border text-xs md:text-sm text-[#303972] bg-transparent py-2"
          />
        </div>
      </div>
